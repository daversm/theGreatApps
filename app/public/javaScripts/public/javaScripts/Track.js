...
var Track = exports.Track = React.createClass({
  ...
  render: function render() {
    return React.createElement('div', null, React.createElement('div', { className: 'trackMasterPanel' }, React.createElement('div', { className: 'trackInfoPanel' }, React.createElement('div', { className: 'trackName' }, ' ', this.props.trackTitle, ' '), React.createElement('div', { className: 'buttonsInsideTrack', onClick: this.handleShowWaveLive }, ' Show Wave '), React.createElement('div', { className: 'buttonsInsideTrack' }, ' Mute '), React.createElement('div', { className: 'buttonsInsideTrack' }, ' Solo '), React.createElement('div', { className: 'buttonsInsideTrack', onClick: this.handleDeleteAudio }, ' Delete Audio ')), React.createElement('div', { className: 'containerTrackDiv' }, React.createElement('div', { className: 'playbackRecordingDiv' }, React.createElement('div', { className: 'playbackOptionsDiv' }, React.createElement('div', { id: 'play', onClick: this.handlePlay }), React.createElement('div', { id: 'stop', onClick: this.handleStop }), React.createElement('div', { id: 'pause', onClick: this.handlePause })), React.createElement('div', { className: 'recordingOptionsDiv' }, React.createElement('div', { id: 'recTrack', onClick: this.handleRecord }), React.createElement('div', { id: 'recStop', onClick: this.handleRecStop }), React.createElement('div', { className: 'icono-headphone', onClick: this.handleDownloadTrack }))), React.createElement('div', { id: this.props.trackName, className: 'waveformContainerDiv' }, ' ')), React.createElement('div', { className: 'trackStatusPanel' }, React.createElement('div', { className: 'trackStatusMsg' }, ' ', this.state.trackStatusMsg, ' ')), React.createElement(Effects, null)));
  }
});
